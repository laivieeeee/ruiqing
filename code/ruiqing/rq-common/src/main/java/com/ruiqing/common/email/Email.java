...
public class Email implements Serializable {
	...
	public String getMailfmTemplate() {
		return mailfmTemplate;
	}

	public void setMailfmTemplate(String mailfmTemplate) {
		this.mailfmTemplate = mailfmTemplate;
	}
